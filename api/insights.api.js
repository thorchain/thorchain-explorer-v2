...
export function getChurnHistory () {
  return $axiosInstace.get(endpoints[process.env.NETWORK].SERVER_URL + 'api/churnHistory')
}

export function getFlipTVL () {
  return $axiosInstace.get(endpoints[process.env.NETWORK].SERVER_URL + 'api/tvlHistoryQuery')
}

export function getRunePrice () {
  return $axiosInstace.get(endpoints[process.env.NETWORK].SERVER_URL + 'api/runePrice')
}
