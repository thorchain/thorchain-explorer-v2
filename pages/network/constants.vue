<template>
  <div class="constants-container">
    <stat-table :tableSettings="outboundTxs" header="Outbound Transactions"></stat-table>
    <stat-table :tableSettings="swapping" header="Swapping"></stat-table>
    <stat-table :tableSettings="lpManagement" header="LP Management"></stat-table>
    <stat-table :tableSettings="chainManagement" header="Chain Management"></stat-table>
    <stat-table :tableSettings="nodeManagement" header="Node Management"></stat-table>
    <stat-table :tableSettings="economics" header="Economics"></stat-table>
  </div>
</template>
