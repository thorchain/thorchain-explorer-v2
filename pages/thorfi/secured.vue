      ...
      <Card title="secured Assets">
        ...
        >
          ...
          <template slot="table-row" slot-scope="props">
            ...
            <div
              v-else-if="props.column.field == 'securedDepth'"
            >
              <span v-if="props.row[props.column.field]">
                <span v-if="usdDenom">$</span>
                {{ props.formattedRow[props.column.field] }}
                <small v-if="!usdDenom">{{ securedToAsset(props.row.asset) }}</small>
              </span>
              <span v-else>-</span>
            </div>
            <span v-else>
  ...
  export default {
    ...
    async mounted() {
      try {
        ...
        this.rows = this.fillsecuredData(this.securedAssets, this.pools, this.asgard)
      } catch (e) {
        this.error = true
        console.error(e)
      } finally {
